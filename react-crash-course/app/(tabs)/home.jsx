      ...
      <ScrollView>
        ...
        <View className="p-5 mb-5">
          ...
          <View className=" bg-secondary-700 p-2 rounded-xl">
            ...
            featuring an amateur radio repeater for global emergency and rescue communications.</Text>
          </View>
        </View>
        <View className="p-5 mb-5">
          ...
          <View className=" bg-secondary-700 p-2 rounded-xl">
            ...
            technologies in a microgravity, high-radiation and low Earth orbit environment.</Text>
          </View>
        </View>
        <View className="p-5 mb-5">
          ...
          <View className=" bg-secondary-700 p-2 rounded-xl">
            <Text className=" pl-2 text-lg mt-2 text-blue-300 font-semibold">The Catarina Constellation encompasses a set of satellites with the goal to provide services,
               mainly, to the civil defence, contributing to the country’s sustainable socioeconomic development agenda.</Text>
          </View>
        </View>
        <View className="p-5 mb-5">
